...
public class Menu extends HttpServlet 
{
	...
	if (p==null) res.sendRedirect("Deconnect");
	...
	else if (p.type.equals("Eleve")){
			out.println("<div class='container'>");
			
			out.println("<div class='page-header'>");
				out.println("<h1>Bonjour "+ p.login + ", que voulez faire ?</h1>");
			out.println("</div>");
			...
			out.println("<ul class='nav nav-pills nav-justified'>");
				out.println("<li role='presentation' class='btn btn-default btn-lg'><a href='SelectAbsence'>Voir les absences</a></li>");
